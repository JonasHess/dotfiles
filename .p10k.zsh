# Generated by Powerlevel10k configuration wizard on 2023-10-19 at 16:41 CEST.
...
#    kubecontext
  ...
  typeset -g POWERLEVEL9K_MODE=font-hack-nerd-font
...
#  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_KUBECONTEXT_NAME}}'
  ...
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='${${:- -n $P9K_KUBECONTEXT_NAMESPACE}:#/default}'
