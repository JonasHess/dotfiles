...
plugins=(zsh-vi-mode copypath zsh-github-copilot terraform tmux globalias iterm2 git kubectl kubectx kube-ps1 zbell alias-finder helm zsh-autosuggestions zsh-syntax-highlighting)
